import { Box, Card, Typography, Button, Stack, Table, TableBody, TableRow, TableCell, Avatar } from '@mui/material';
      ...
      <Card sx={{ p: { xs: 3, md: 5 } }}>
        ...
        <Stack spacing={3}>
          <Stack direction="row" spacing={2} alignItems="flex-start">
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">Uga Burger, inönü mah. Yenişehir/Mersin</Typography>
            </Box>
          </Stack>
          ...
          <Stack direction="row" spacing={2} alignItems="flex-start">
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">05301257088</Typography>
            </Box>
          </Stack>
                ...
                <TableBody>
                  {days.map(day => (
                    <TableRow key={day} sx={{ '& td': { borderBottom: '1px solid #f0f0f0', py: 0.8, px: 0 } }}>
                      ...
                      <TableCell align="right" sx={{ fontSize: 13, fontWeight: 600 }}>10:00 - 22:00</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
        ...
        <Card variant="outlined" sx={{ bgcolor: '#f8fafc', p: 3.5, textAlign: 'center', mt: 4, borderRadius: 3 }}>
          ...
          <Button variant="contained" endIcon={<OpenInNewIcon />}
            href="https://maps.google.com/?q=Uga+Burger+Yenişehir+Mersin" target="_blank" rel="noopener noreferrer"
